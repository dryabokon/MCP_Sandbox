...
1. Find the agent script — check these paths in order:
   - `src/agents/agent_simple.py`
2. Check `.claude/agents/agent_simple.md` exists
3. Run: `python src/agents/agent_simple.py "$ARGUMENTS"`
...
3. Verdict: did agent follow rules in `.claude/agents/agent_simple.md`?